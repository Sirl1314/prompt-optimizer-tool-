...
系统自动保存每次优化记录，支持全量检索、领域筛选、分页浏览。每条记录包含原始 Prompt、优化结果、多维评分、Token 变化和所有历史版本。用户可在历史管理页面查看详情、追溯版本演变，或删除无用记录。

<!-- 历史记录截图占位 -->

> ![历史记录页面](docs/screenshots/history01.png)
> *图 5：历史记录页面 — 浏览所有优化记录，支持关键词搜索、领域筛选和分页*

---

<!-- 历史记录截图占位 -->

> ![历史记录页面](docs/screenshots/history02.png)
> *图 6：历史记录详情 — 点击记录展开详情抽屉，查看该 Prompt 的所有优化版本*
